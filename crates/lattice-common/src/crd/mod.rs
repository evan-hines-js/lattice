...
pub use service::{
    ...
    PortSpec, Probe, RateLimitConfig, RateLimitSpec, ReplicaSpec, ResourceMetadata, ResourceSpec,
    ResourceType, RetryConfig, ServicePhase, ServicePortsSpec, TimeoutConfig, TlsMode,
