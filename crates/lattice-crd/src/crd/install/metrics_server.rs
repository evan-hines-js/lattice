//! MetricsServerInstall CRD — desired state for the metrics-server install.
...
#[kube(
    group = "lattice.dev",
    version = "v1alpha1",
    kind = "MetricsServerInstall",
    plural = "metricsserverinstalls",
    shortname = "msi",
...
pub struct MetricsServerInstallSpec {
    #[serde(flatten)]
    pub base: InstallSpecBase,
}

impl InstallResource for MetricsServerInstall {
