//! KthenaInstall CRD — desired state for the Kthena model-serving install.
...
pub struct KthenaInstallSpec {
    #[serde(flatten)]
    pub base: InstallSpecBase,
}

impl InstallResource for KthenaInstall {
