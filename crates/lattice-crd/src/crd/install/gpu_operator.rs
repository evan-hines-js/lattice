//! GpuOperatorInstall CRD — desired state for the NVIDIA GPU Operator install.
...
#[kube(
    group = "lattice.dev",
    version = "v1alpha1",
    kind = "GpuOperatorInstall",
    plural = "gpuoperatorinstalls",
    shortname = "goi",
...
pub struct GpuOperatorInstallSpec {
    #[serde(flatten)]
    pub base: InstallSpecBase,
}

impl InstallResource for GpuOperatorInstall {
