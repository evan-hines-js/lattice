//! Test helpers for kind-based integration tests
//!
//! Provides utilities for managing kind clusters and installing CRDs.
//! These are quick integration tests that don't use the full Installer.
...
pub async fn ensure_test_cluster() -> Result<Client, String> {
    ...
    // Ensure cluster is created exactly once using OnceLock
