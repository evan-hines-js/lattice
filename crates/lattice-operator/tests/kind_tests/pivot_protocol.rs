...
use lattice_operator::agent::connection::{AgentRegistry, PostPivotManifests};
...
use lattice_operator::proto::cell_command::Command as CellCommandType;
use lattice_operator::proto::lattice_agent_client::LatticeAgentClient;
use lattice_operator::proto::{
...
async fn run_pivot_e2e_test() -> Result<(), String> {
    ...
    let pivot_cmd = lattice_operator::proto::CellCommand {
...
async fn simulate_agent_connection(
    ...
    (
        ...
        mpsc::Receiver<lattice_operator::proto::CellCommand>,
    ),
    String,
> {
    ...
    let (cmd_tx, cmd_rx) = mpsc::channel::<lattice_operator::proto::CellCommand>(32);
...
async fn story_pivot_failure_handled_gracefully() {
    ...
    registry
        .send_command(
            cluster_name,
            lattice_operator::proto::CellCommand {
